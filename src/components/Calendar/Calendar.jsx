import { CalendarBlock, CalendarNav, DataText, NavActions, SCalendar, CalendarMonth, NavAction, CalendarContent, CalendarDays, CalendarPeriod, CalendarTerm } from "./Calendar.styled";
    ...
    <>
      <SCalendar>
        ...
        <CalendarBlock>
          ...
          <CalendarPeriod>
            <CalendarTerm>Выберите срок исполнения <span className="date-control"></span>.</CalendarTerm>
          </CalendarPeriod>
        </CalendarBlock>
      </SCalendar>
    </>
