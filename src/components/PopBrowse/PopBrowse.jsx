...
export function PopBrowse() {
  ...
  const handleInputChang = (e, field) => {
    setEditableTask({
      ...editableTask,
  ...
  const saveChanges = async () => {
    try {
      ...
      console.error("Ошибка при сохранении изменений:", error.massage);
    }
  };
            ...
            <div className="pop-browse__wrap">
              <form className="pop-browse__form form-browse" id="formBrowseCard" action="#">
                <div className="form-browse__block">
                  <label htmlFor="textArea01" className="subttl">{task.description}</label>
